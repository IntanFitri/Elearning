...
if($_FILES['gambar']['error']==0){
	...
	if (move_uploaded_file($temp_foto, $path)){
		...
		$sql = "UPDATE `data_mahasiswa` SET `NRP`= '$NRP', `Nama_Mahasiswa` = '$Nama', `Jenis_kelamin` = '$JenisKelamin', `Alamat` = '$Alamat', `No_Telepon` = '$Nomor', `Umur` = '$Umur' , Gambar='$path' WHERE `data_mahasiswa`.`id_mhs` = $id;";  
