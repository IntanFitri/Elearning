...
if(isset($_FILES['gambar']['name'])){
	...
	if (move_uploaded_file($temp_foto, $path)){
		$sql = "INSERT INTO data_mahasiswa(NRP,Nama_Mahasiswa, Jenis_Kelamin, Alamat, No_Telepon, Umur, Gambar) 
		VALUES ('$NRP','$nama', '$jns', '$alamat', '$nomor', $umur, '$path');";
		...
		if($query){
			...
			echo "<script>alert('Data Gagal Ditambahkan');dokument.location.href='index.php?page=Tampil_Mahasiswa'</script>";
		}
	}else{
