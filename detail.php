...
<body>
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="tampil2.php">Isi Data Mahasiswa</a></li>
...
<div class="container" align="center">
	<form action="proses_edit.php" method="POST" style="border-style: solid;">
		...
		<br>
		<br>
		<a href="tampil2.php"><button type ="button" class "btn_kembali">KEMBALI <span class ="fa fa-close"></span> </button></a>
